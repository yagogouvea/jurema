...
import { pdvNotificationsRouter } from "./routers/pdvNotifications";
...
import { pdvFinanceiroRouter } from "./routers/pdvFinanceiro";
...
export const appRouter = router({
  ...
  pdvNotifications: pdvNotificationsRouter,
  ...
  pdvFinanceiro: pdvFinanceiroRouter,
  wa: waRouter,
  ...
  products: router({
    ...
    create: adminProcedure
      .input(z.object({
        ...
        team: z.string().optional(),
        category: z.enum(['1linha-nacional', 'tailandesa-promocao', 'itens-brasil', 'conj-calor-nacional', 'conj-calor-tailandesa', 'tailandesa', 'infantil', 'jogador-tailandesa', 'retro-tailandesa', 'conj-frio-tailandes', 'tailandesa-3xl', 'tailandesa-4xl']).default('tailandesa'),
    ...
    update: adminProcedure
      .input(z.object({
        ...
        team: z.string().optional(),
        category: z.enum(['1linha-nacional', 'tailandesa-promocao', 'itens-brasil', 'conj-calor-nacional', 'conj-calor-tailandesa', 'tailandesa', 'infantil', 'jogador-tailandesa', 'retro-tailandesa', 'conj-frio-tailandes', 'tailandesa-3xl', 'tailandesa-4xl']).optional(),
