  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        ...
        {/* Expandable label */}
        <span className="max-w-0 overflow-hidden whitespace-nowrap group-hover:max-w-[120px] transition-all duration-300 font-['Bebas_Neue'] text-sm tracking-widest text-white">
          WHATSAPP
        </span>
      </a>
    </div>
