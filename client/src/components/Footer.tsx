...
export default function Footer() {
  return (
    <footer className="bg-[#0A0A0A] border-t border-[#C8102E]/20 mt-16">
      {/* Trust badges */}
        ...
        <div className="container py-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-3 justify-center sm:justify-end">
              <div className="w-10 h-10 rounded-full bg-[#C8102E]/10 flex items-center justify-center flex-shrink-0">
                <CreditCard size={20} className="text-[#C8102E]" />
              </div>
              <div>
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="https://instagram.com/jumerasport" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-[#1A1A1A] flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#C8102E] transition-all">
                <Instagram size={16} />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="text-gray-500 hover:text-[#C8102E] text-sm transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-gray-500 text-sm">
                <Phone size={15} className="text-[#C8102E] mt-0.5 flex-shrink-0" />
                <span>(00) 00000-0000</span>
              </li>
              <li className="flex items-start gap-2 text-gray-500 text-sm">
                <Mail size={15} className="text-[#C8102E] mt-0.5 flex-shrink-0" />
                <span>contato@jumerasport.com.br</span>
              </li>
              <li className="flex items-start gap-2 text-gray-500 text-sm">
                <MapPin size={15} className="text-[#C8102E] mt-0.5 flex-shrink-0" />
                <span>Brasil</span>
              </li>
            </ul>
            {/* Payment methods */}
